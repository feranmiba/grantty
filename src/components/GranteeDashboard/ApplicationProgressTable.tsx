...
const steps = [
  { step: 1, name: "Company Info", status: "Completed" },
  { step: 2, name: "Founder Details", status: "Completed" },
  { step: 3, name: "Company Overview", status: "Completed" },
...
const statusStyles = {
  Completed: "text-green-500 bg-green-50 border border-green-200",
  "Not Completed": "text-red-500 bg-red-50 border border-red-200",
};
