...
export default function NotificationSettingsCard() {
  ...
  return (
    <div className="overflow-x-auto  bg-[#FFFFFF] rounded-xl px-5 py-5 space-y-5 border-[#F0EBFB] border-2 text-[#21283B]">
      ...
      <div className="flex flex-col gap-4">
        {notifications.map((notif, idx) => (
          <div key={idx} className="flex items-center justify-between mt-3 text-lg">
            <Label className="text-lg font-normal">{notif.label}</Label>
            <Switch
